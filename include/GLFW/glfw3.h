 ...
 *
 * 2. Altered resources versions must be plainly marked as such, and must not
 *    be misrepresented as being the original software.
 *
 * 3. This notice may not be removed or altered from any resources
 *    distribution.
 *
 *************************************************************************/
 ...
 *  template for this, which can be found as `CMake/Info.plist.in` in the resources
 *  tree.
 *
 ...
 *  resources file including empty lines and comments.
 *
 ...
 *  time resources on each operating system.
 *
