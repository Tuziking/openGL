...
// - to make the demo resources code faster to read, faster to change, smaller in size.
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Tree Nodes"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            ImGui::Checkbox("Test tree node as drag resources", &test_drag_and_drop);
            ImGui::Text("Hello!");
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                if (i < 3)
                {
                    ...
                    if (test_drag_and_drop && ImGui::BeginDragDropSource())
                    {
                        ...
                        ImGui::Text("This is a drag and drop resources");
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("UTF-8 Text"))
        {
            ...
            //   can save your resources files as 'UTF-8 without signature').
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        // of their respective resources file to specify what they expect to be stored in ImTextureID, for example:
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Multi-line Text Input"))
        {
            ...
            ImGui::InputTextMultiline("##resources", text, IM_ARRAYSIZE(text), ImVec2(-FLT_MIN, ImGui::GetTextLineHeight() * 16), flags);
            ImGui::TreePop();
        }
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            for (int n = 0; n < IM_ARRAYSIZE(saved_palette); n++)
            {
                ...
                // drag resources by default, unless specifying the ImGuiColorEditFlags_NoDragDrop flag.
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        {
            // ColorEdit widgets automatically act as drag resources and drag target.
...
// If a tab has been closed programmatically (aka closed from another resources such as the Checkbox() in the demo,
